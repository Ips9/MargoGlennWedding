...
export function initializeGuestPortal() {
  ...
  function applySession(data) {
    ...
    $('#invitationIntro').textContent = dinner && evening
      ...
      : `${multiple ? 'Kunnen jullie' : 'Kan je'} erbij zijn op ${evening ? 'ons avondfeest' : 'onze receptie en het diner'}?`
